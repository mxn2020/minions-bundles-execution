# Manual Setup Steps for Minions Bundle: Execution
...
Go to **GitHub → mxn2020/minions-bundles-execution → Settings → Secrets and variables → Actions** and add:
...
### Web App (Playground)
- **Netlify site name**: `minions-bundles-execution-web`
- **GitHub repo**: `mxn2020/minions-bundles-execution`
...
### Documentation
- **Netlify site name**: `minions-bundles-execution-docs`
- **GitHub repo**: `mxn2020/minions-bundles-execution`
...
### Blog
- **Netlify site name**: `minions-bundles-execution-blog`
- **GitHub repo**: `mxn2020/minions-bundles-execution`
...
|--------|------|------|-------|
| Docs | CNAME | `execution.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `execution.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `execution.minions.wtf` | _(Netlify subdomain)_ |
...
| Item | Value |
|------|-------|
| Project | `minions-bundles-execution` |
| SDK (npm) | `undefined` |
| CLI (npm) | `undefined` |
| Python (PyPI) | `undefined` |
| GitHub | `github.com/mxn2020/minions-bundles-execution` |
