---
title: Introduction
description: "Get started with Minions Bundle: Execution"
---
...
- **TypeScript SDK** (`@minions-bundles-execution/sdk`) — Core library for Node.js
- **Python SDK** (`minions-bundles-execution`) — Python bindings
- **CLI Tool** (`@minions-bundles-execution/cli`) — Command-line interface
